...
BOOST_AUTO_TEST_CASE(test_tag8_zero)
{
    ...
    transenc::detail::decoder decoder(input, input + sizeof(input));
    BOOST_REQUIRE_EQUAL(decoder.type(), transenc::detail::token_tag8);
...
BOOST_AUTO_TEST_CASE(test_tag16_one)
{
    ...
    transenc::detail::decoder decoder(input, input + sizeof(input));
    BOOST_REQUIRE_EQUAL(decoder.type(), transenc::detail::token_tag16);
...
BOOST_AUTO_TEST_CASE(test_tag32_one)
{
    ...
    transenc::detail::decoder decoder(input, input + sizeof(input));
    BOOST_REQUIRE_EQUAL(decoder.type(), transenc::detail::token_tag32);
...
BOOST_AUTO_TEST_CASE(test_tag64_one)
{
    ...
    transenc::detail::decoder decoder(input, input + sizeof(input));
    BOOST_REQUIRE_EQUAL(decoder.type(), transenc::detail::token_tag64);
...
BOOST_AUTO_TEST_CASE(test_name_int8_empty)
{
    ...
    transenc::detail::decoder decoder(input, input + sizeof(input));
    BOOST_REQUIRE_EQUAL(decoder.type(), transenc::detail::token_name);
