...
BOOST_AUTO_TEST_CASE(test_empty)
{
    ...
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_junk)
{
    const char input[] = "\t";
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_error);
}
...
BOOST_AUTO_TEST_CASE(test_null)
{
    const char input[] = "Z";
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_null);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_true)
{
    const char input[] = "T";
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_true);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_false)
{
    const char input[] = "F";
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_false);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_int8_zero)
{
    ...
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_int8);
...
BOOST_AUTO_TEST_CASE(test_int16_zero)
{
    ...
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_int16);
...
BOOST_AUTO_TEST_CASE(test_int32_zero)
{
    ...
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_int32);
...
BOOST_AUTO_TEST_CASE(test_int64_zero)
{
    ...
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_int64);
...
BOOST_AUTO_TEST_CASE(test_float32_zero)
{
    ...
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_float32);
...
BOOST_AUTO_TEST_CASE(test_float64_zero)
{
    ...
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_float64);
...
BOOST_AUTO_TEST_CASE(test_string_empty)
{
    ...
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_string);
...
BOOST_AUTO_TEST_CASE(test_object_begin)
{
    const char input[] = "{";
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_object_begin);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_object_end)
{
    const char input[] = "}";
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_object_end);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_array_begin)
{
    const char input[] = "[";
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_array_begin);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_array_end)
{
    const char input[] = "]";
    ubjson::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_array_end);
    BOOST_REQUIRE_EQUAL(decoder.next(), ubjson::token_eof);
}
