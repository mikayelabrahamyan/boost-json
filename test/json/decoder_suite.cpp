...
{
    const char input[] = "";
    json::detail::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_junk)
{
    ...
    json::detail::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_error);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_error);
}
...
BOOST_AUTO_TEST_CASE(test_null)
{
    ...
    json::detail::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_null);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_false)
{
    ...
    json::detail::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_false);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_true)
{
    ...
    json::detail::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_true);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_integer_zero)
{
    const char input[] = "0";
    json::detail::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_integer);
...
BOOST_AUTO_TEST_CASE(test_float_zero)
{
    ...
    json::detail::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_float);
...
BOOST_AUTO_TEST_CASE(test_string_empty)
{
    const char input[] = "\"\"";
    json::detail::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_string);
...
BOOST_AUTO_TEST_CASE(test_object_begin)
{
    const char input[] = "{";
    json::detail::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_object_begin);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_object_end)
{
    const char input[] = "}";
    json::detail::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_object_end);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_object)
{
    ...
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_colon);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_false);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_object_end);
...
BOOST_AUTO_TEST_CASE(test_array_begin)
{
    const char input[] = "[";
    json::detail::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_array_begin);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_array_end)
{
    const char input[] = "]";
    json::detail::decoder decoder(input, input + sizeof(input) - 1);
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_array_end);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_eof);
}
...
BOOST_AUTO_TEST_CASE(test_array)
{
    ...
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_true);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_comma);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_false);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.type(), json::detail::token_array_end);
